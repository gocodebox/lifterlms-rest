...
+ `llms-dev pot`: Build a release: spec, doc code snippets, and included language files.
...
[img-travis]: https://img.shields.io/travis/com/gocodebox/lifterlms-rest?logo=travis-ci&logoColor=white&style=for-the-badge
